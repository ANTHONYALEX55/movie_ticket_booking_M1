...
SECRET_KEY = 'django-insecure-b1yd3reqzyommb2o3h9c9&pex9^xs*1c0%-@zt55*^&7@btsge'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "assets"),   # <-- adjust to where your CSS/JS really are
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'support@arkcode.in'
EMAIL_HOST_PASSWORD = 'Gloria@55'
